...
# ******************* #
# ~ CONDITIONS HERE ~ #
# print("RIVER BANK: ", river_bank)
# print("ZATVORENICI: ", zatvorenici)
# print("TRGOVCI: ", trgovci)
# print()
# USLOVOT:
# Ako ima poveke zatvorenici od trgovci!!
# No mora da ima trgovci za uslovot da ima smisla
if zatvorenici > trgovci and trgovci > 0:
    return False
## zad 10 uslovot
   if 'D-1' in river_bank:
            if 'M-2' in river_bank or 'T-2' in river_bank:
                if 'M-1' not in river_bank and 'T-1' not in river_bank:
                    return False
        if 'D-2' in river_bank:
            if 'M-1' in river_bank or 'T-1' in river_bank:
                if 'M-2' not in river_bank and 'T-2' not in river_bank:
                    return False
        if len(river_bank) ==