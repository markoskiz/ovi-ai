...
passengers = ['Z_1', 'Z_2', 'Z_3', 'T_1', 'T_2', 'T_3']
...
def main():
    ...
    start_state = ('left', 'left', 'left', 'left', 'right', 'right', 'right')
...
#     * Никогаш не смеат да останат повеќе затвореници од трговци на иста страна од реката.
        ...
        zatvorenici = 0
        trgovci = 0
        # Go doznavame brojot na trgovci i zatvorenici za momentalnata river_bank:
        for passenger in river_bank:
            if 'Z' in passenger:
                # Ako se zatvorenici:
                zatvorenici += 1
